...
#'
#' This is a table of six lists used in the research \href{https://www.gov.uk/government/publications/modern-slavery-an-application-of-multiple-systems-estimation}{published by the Home Office} as part of the strategy leading
